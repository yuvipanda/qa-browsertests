class PageTriagePage
  ...
  a(:learn_more, href: '//en.wikipedia.org/wiki/Wikipedia:Page_Curation/Help', text: 'Learn more')
  a(:leave_feedback, href: '//en.wikipedia.org/wiki/Wikipedia_talk:Page_Curation', text: 'Leave feedback')
